...
export default function Buy({ navigation }){
    ...
    const fetchUser = async () => {
        ...
        await axios.get(`${backend}/api/item/getAllItems`, config).then((response) => {
    ...
    <ImageBackground source={bg} resizeMode="stretch" style={styles.image}>
        ...
        <ScrollView>
            ...
            <View style={styles.container} key={item._id}>
                <TouchableOpacity onPress={(e) => selectItem(e, item._id)} style={styles.OrderIMG}>
                ...
                <Button
                    ...
                    color="#000"
                    onPress={(e) => selectItem(e, item._id)}
                />
            </View>
            ))}
            </View>
